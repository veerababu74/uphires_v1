    ...
    def vector_similarity_search(self, query: str, limit: int = 50) -> Dict:
        ...
        try:
            ...
            for i, result in enumerate(processed_results):
                logger.info(
                    f"Rank {i+1}: ID: {result['_id']}, Score: {result['score']:.4f}"
                )
...
def ask_resume_question_preset(question, preset="fast"):
    """
...
def main():
    """Main function to demonstrate the simplified search interface"""
    try:
