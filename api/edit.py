...
"""
        ...
        resume_dict["total_resume_text"] = combined_resume
        ...
        # Use resume_ops.create_resume() which will handle vectorization using the core Vectorizer
        result = resume_ops.create_resume(resume_dict)
